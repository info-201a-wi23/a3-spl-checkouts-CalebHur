...
Over the past decade, the Seattle Public Library has been meticulously gathering a plethora of checkout data, giving way to new discoveries to analyze the habits of library-goers. My personal interest concerns the medium in which books are read; ever since the introduction of online books, my father and I believed services such as the Kindle would skyrocket in popularity. With this data, I can determine the success of electronic reading material.
