...
I then wondered if physical library material had a similar increase in popularity. I isolated traditional books, sound discs, and video discs as three popular forms of the physical medium and found their popularity has actually *decreased* over the 7-year period. For traditional books, there has been a slight decrease by roughly 2,825 checkouts per year; for sound discs, 6,061; for video discs, 15,138.

So then, I wondered if this trend persisted across all forms of digital and physical media. I found that a much starker difference was shown with the physical medium decreasing by 23,883 checkouts per year and the digital medium increasing by 23,017 checkouts per year over the same time period. It seems that there are specific reasons why digital mediums are preferred over physical ones.
...
As mentioned, the Seattle Public Library collected and published the data used for these findings. The data consists of 12 parameters: UsageClass, either physical or digital media; CheckoutType, the medium in which the material was checked out through; MaterialType, the specific form of the content (ebook, video disc, etc.); CheckoutYear, CheckoutMonth, Title, ISBN, Creator, Subjects, Publisher PublicationYear.

The data was first collected by an artist and professor since 2005, working independently for an art installation involving library checkouts. However, the first initiative to create an open source database for previously private government resources was under the presidency of Barack Obama. Ever since 2017, the library checkouts (including those collected by the professor) have been documented and shared publicly for use.
...
Much of the motivation for the graph below is explained above in the summary.
